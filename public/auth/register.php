...
<div class="floating">
    ...
    <div class="float-left">
        <img src="/src/img/register_vector.png" alt="Register vector" style="width: 512px; height: 564px; position: abolute; margin: 5%; border-top-left-radius: 5px; border-bottom-left-radius: 5px;">
    </div>
