...
<div class="floating">
    ...
    <div class="float-left">
        <img src="/src/img/login_vector.png" alt="Login vector" style="width: 451px; height: 609px;position: absolute; margin: 5%; margin-left: 13%; border-top-left-radius: 5px; border-bottom-left-radius: 5px;">
    </div>
